...
1. Calculer l'abondance totale pour 'abba', son abondance moyenne et le coefficient de variation de son abondance ;
...
N_sd_abba = sd(quadrats$abba)
N_CV_abba = N_sd_abba / N_moy_abba
```
