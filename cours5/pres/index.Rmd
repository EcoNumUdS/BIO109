...
coordx <- seq(0,180,20)
coordy <- seq(0,980,20)
# transformer l'état des lettres en chiffres
etats[which(etats == "M")] <- 1 # répétez pour les autres états
paysage <- matrix(etats, ncol = length(coordx),
		nrow = length(coordy), byrow = TRUE)
par(mar = c(4,4,3,0.5))
...
---
# Changement de distribution au fil du temps

<div style='text-align:center;'>
<img src="assets/img/animation.gif" height="520px"></img>
</div>
