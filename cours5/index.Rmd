...
On peut utiliser la loi binomiale pour simuler le nombre de fois où l'on obtient pile. On obtient alors un vecteur de 10 nombres aléatoires. On peut ensuite compter le nombre de 1 dans ce vecteur.
