...
<img src="assets/img/intro/bioclim.jpg" height="400px"></img>
...
<img src="assets/img/intro/mont_vertes.jpg" height="400px"></img>
...
'''
arbres = read.table(file = 'arbres.txt', header = TRUE, dec = ",")
head(arbres)
'''
...
<img src="assets/img/intro/modeles.jpg" height="400px"></img>

---

# Aujourd'hui

<img src="assets/img/intro/cartes_vissault.jpg" height="400px"></img>
