...
Un membre par équipe, doit remettre le pseudo-code pour chacune des fonctions, à l'exception de la commande qui tire au hasard l'état au temps t+1 (inscrire `COMPUTE etat_t1`)
