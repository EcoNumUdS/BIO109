...
1. Transformer les abondances en états de départ
...
3. Fonction qui fait une simulation sur N pas de temps, pour une composition de départ ETATS0, et retourne la composition (proportion de chaque état sur l'ensemble de la placette) à chaque pas de temps
...
5. Utiliser la sortie de la fonction pour répondre aux question suivantes : 
  ...
  > ii) à quelle vitesse se transformerait une forêt entière constituée d'un mélange de feuillus et de conifères au départ ?

---
# Modalités

Le travail se réalisera en équipe de 2
- Une première remise *formative* du pseudo-code se fera avant la séance 5 (7 février, 8:29)
- Un membre par équipe, doit remettre
  - Le pseudo-code pour chacune des fonctions, à l'exception du bloc qui tire au hasard l'état au temps t+1
  - Inscrire `COMPUTE N_t1` 


- Le travail terminal doit être remis **électroniquement** pour l'évaluation *sommative* au plus tard le 21 février 23:59 sur Moodle
- **Vous tous** devez remettre:
	- Le pseudo-code bonifié pour chacune des fonctions qui réalise votre simulation, incluant le tirage au hasard
  ...
  - Moodle n'accepte qu'un seul fichier, vous pouver compression votre répertoire de travail et remettre le fichier zip
